export const settings = {
  ...
  "DistPacketGenerator": {
    ...
    "arrival_dist": {
      ...
      "type": "float",
      "required": true,
      "helperText": "A no-parameter function that returns the successive inter-arrival times of the packets."
    },
    "size_dist": {
      "default": 0.1,
      "type": "float",
      "required": true,
      "helperText": "A no-parameter function that returns the successive sizes of the packets."
    },
    "initial_delay": {
      "default": 0,
      "type": "float",
  ...
  "PacketSink": {
    ...
    "absolute_arrivals": {
      ...
      "type": "boolean",
      "required": true,
      "helperText": "if True absolute arrival times will be recorded, " + 
    ...
    "rec_flow_ids": {
      ...
      "type": "boolean",
      "required": true,
      "helperText": "if True, the flow IDs that the packets are used as the index for recording; " +
